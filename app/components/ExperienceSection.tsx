...
const experiences: ExperienceItem[] = [
  ...
  },
  {
    ...
    period: "2020 - 2021",
    description:
      "aggregated market data for assets like these and helped investors understand them better",
  },
];
    ...
    <div className="flex flex-col gap-y-8">
      ...
      {experiences.map((exp, index) => (
        <div key={exp.company} className="flex flex-col w-full">
          ...
          {index === 0 && (
            <div className="">
              <video autoPlay loop muted playsInline className="w-20">
                <source
                  src="https://pj55yltg5v.ufs.sh/f/GEQYflcXsdIYGCatiicXsdIYfbtW7MPAwgNvyn0ZRJ8jpcqo"
                  type="video/mp4"
                />
              </video>
            </div>
          )}
          {index === 3 && <MixedMediaSlider />}
          {index === 2 && (
